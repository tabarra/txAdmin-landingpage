        ...
        <div className="mx-auto justify-center text-center w-9/12 gap-4 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
          <div className="flex bg-content group transform duration-200 ease-in-out hover:scale-105 rounded-2xl">
            <div className="space-y-2 mx-auto p-7">
              <ServerIcon className="flex mx-auto justify-center h-14 w-14 bg-txgreen duration-200 ease-in-out group-hover:bg-green-500 text-gray-800 rounded-2xl p-3" />
          ...
          <div className="flex bg-content group transform duration-200 ease-in-out hover:scale-105 rounded-2xl">
            <div className="space-y-2 mx-auto p-7">
              <AdjustmentsIcon className="flex mx-auto justify-center h-14 w-14 bg-txgreen duration-200 ease-in-out group-hover:bg-green-500 text-gray-800 rounded-2xl p-3" />
          ...
          <div className="flex bg-content group transform duration-200 ease-in-out hover:scale-105 rounded-2xl">
            <div className="space-y-2 mx-auto p-7">
              <ChartBarIcon className="flex mx-auto justify-center h-14 w-14 bg-txgreen duration-200 ease-in-out group-hover:bg-green-500 text-gray-800 rounded-2xl p-3" />
          ...
          <div className="flex bg-content group transform duration-200 ease-in-out hover:scale-105 rounded-2xl">
            <div className="space-y-2 mx-auto p-7">
              <UsersIcon className="flex mx-auto justify-center h-14 w-14 bg-txgreen duration-200 ease-in-out group-hover:bg-green-500 text-gray-800 rounded-2xl p-3" />
          ...
          <div className="flex bg-content group transform duration-200 ease-in-out hover:scale-105 rounded-2xl">
            <div className="space-y-2 mx-auto p-7">
              <LockClosedIcon className="flex mx-auto justify-center h-14 w-14 bg-txgreen duration-200 ease-in-out group-hover:bg-green-500 text-gray-800 rounded-2xl p-3" />
          ...
          <div className="flex bg-content group transform duration-200 ease-in-out hover:scale-105 rounded-2xl">
            <div className="space-y-2 mx-auto p-7">
              <SearchIcon className="flex mx-auto justify-center h-14 w-14 bg-txgreen duration-200 ease-in-out group-hover:bg-green-500 text-gray-800 rounded-2xl p-3" />
