    ...
    <div className="flex flex-col md:flex-row space-y-5 md:space-y-0 mx-auto justify-evenly items-center">
      <div className="w-4/5 md:w-2/5 text-center md:text-left">
          <div className="space-y-2">
            <h2 className="text-4xl font-bold text-white">Managing your FiveM server just got <span className="text-transparent bg-clip-text bg-gradient-to-t from-emerald-300 to-emerald-500">better</span>.</h2>
        ...
        <div className="bg-[url('/snaily.svg')] bg-cover flex items-center w-80 h-80 md:w-96 md:h-96 rounded-2xl">
