  ...
  return (
    <div className='flex flex-col md:flex-row space-y-5 md:space-y-0 mx-auto justify-evenly items-center'>
      <div className='w-4/5 md:w-2/5 text-center md:text-left'>
        <Reveal keyframes={slideLeft} triggerOnce>
          <div className='space-y-2'>
            ...
            <p className='text-gray-400 text-lg'>
              txAdmin offers a wide range of features designed to make managing a FiveM
              server as easy as anything. Setting up txAdmin is completely free, begin
              your journey on using the most simplistic, yet functional FiveM server web
              panel.
            </p>
          </div>
        </Reveal>
