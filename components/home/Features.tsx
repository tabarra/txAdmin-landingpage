  ...
  return (
    <div className='flex bg-neutral-800 group transform duration-200 ease-in-out hover:scale-105 rounded-2xl'>
      <div className='space-y-2 mx-auto p-7'>
        <FeatureIcon className='flex mx-auto justify-center h-14 w-14 bg-txgreen duration-200 ease-in-out group-hover:bg-emerald-400 text-neutral-800 rounded-2xl p-3' />
        <h4 className='text-center font-medium text-2xl text-white'>{title}</h4>
        <p className='text-txneutraltext'>{description}</p>
      </div>
    </div>
  );
};
    ...
    transition={{
      ...
      ease: "easeInOut",
        ...
        <div className='text-center space-y-2 m-8'>
          ...
          <p className='text-txneutraltext text-base'>
