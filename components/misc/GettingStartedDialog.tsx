              ...
              <div className='bg-txneutralbg px-4 pt-5 pb-4 sm:p-6 sm:pb-4'>
                <div className='space-y-4'>
                  ...
                  <div className='mt-3 text-center sm:mt-0 sm:text-left'>
                    ...
                    <div className='mt-2'>
                      <p className='text-sm text-txneutraltext'>
                        ...
                        to find hosting options, or follow the manual setup guide if you
                        prefer to download and configure your server yourself.
                      </p>
                    </div>
                  </div>
                </div>
